#ifndef INCLUDED_VISHV_OBB_COLLIDER_COMPONENT
#define INCLUDED_VISHV_OBB_COLLIDER_COMPONENT
...
namespace Vishv::Components
{
	...
	public:
		...
		bool IsTrigger() { return mColliderOBB.IsTrigger(); }
		bool IsStatic();
	...
	private:
		...
		Vishv::Physics::OBB mColliderOBB;
	};
}
#endif
