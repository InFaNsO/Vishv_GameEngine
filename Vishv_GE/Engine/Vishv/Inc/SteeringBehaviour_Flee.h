#ifndef INCLUDED_VISHV_AI_STEERINGBEHAVIOUR_FLEE_H
#define INCLUDED_VISHV_AI_STEERINGBEHAVIOUR_FLEE_H
...
namespace Vishv::AI::Steering
{
	...
	class Flee : public BehaviourBase<Components::AIAgent>
	{
	public:
	...
	private:
		SteeringType mSteeringType = SteeringType::Flee;
	};
}
