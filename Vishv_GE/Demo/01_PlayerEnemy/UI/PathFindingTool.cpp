	...
	else
	{
		...
		if (ImGui::Button("FindPath") && searchType != 0)
		{
			if (!(startCol == endCol && startRow == endRow))
			{
				...
				{
				case Vishv::AI::GraphSearch::SearchType::BreathFirstSearch:
					yourGraphSearch->RunBreathFirstSearch((Vishv::AI::NodeID)yourGraphSearch->GetNodeID(startRow, startCol, maxCol), (Vishv::AI::NodeID)yourGraphSearch->GetNodeID(endRow, endCol, maxCol));
					break;
				case Vishv::AI::GraphSearch::SearchType::DepthFirstSearch:
					yourGraphSearch->RunDepthFirstSearch((Vishv::AI::NodeID)yourGraphSearch->GetNodeID(startRow, startCol, maxCol), (Vishv::AI::NodeID)yourGraphSearch->GetNodeID(endRow, endCol, maxCol));
					break;
				case Vishv::AI::GraphSearch::SearchType::Dijkstra:
					yourGraphSearch->RunDijkstra((Vishv::AI::NodeID)yourGraphSearch->GetNodeID(startRow, startCol, maxCol), (Vishv::AI::NodeID)yourGraphSearch->GetNodeID(endRow, endCol, maxCol), CostFunction);
					break;
				case Vishv::AI::GraphSearch::SearchType::AStar:
				{
					//to do member variables
						...
						//	CostFunction();
						//};
					yourGraphSearch->RunAStar((Vishv::AI::NodeID)yourGraphSearch->GetNodeID(startRow, startCol, maxCol), (Vishv::AI::NodeID)yourGraphSearch->GetNodeID(endRow, endCol, maxCol), CostFunction, HeuristicFunction);
				}
				break;
