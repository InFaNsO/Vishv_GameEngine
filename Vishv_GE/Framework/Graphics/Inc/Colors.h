...
#ifndef INCLUDED_VISHV_GRAPHICS_COLORS_H
#define INCLUDED_VISHV_GRAPHICS_COLORS_H

#include "Common.h"

namespace Vishv::Graphics {

using Color = Vishv::Math::Vector4;
...
#endif // #ifndef INCLUDED_VISHV_GRAPHICS_COLORS_H
