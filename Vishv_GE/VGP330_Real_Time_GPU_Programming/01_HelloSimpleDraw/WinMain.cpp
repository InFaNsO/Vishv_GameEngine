...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int)
{
	...
	myWindow.Initialize(hInstance, "Hello Simple Draw", 1280, 720);
	...
	EffectsManager::StaticInitialize();
	...
	while (!done)
	{
		...
		SimpleDraw::AddSphere({ 100.0f, 100.0f, 50.0f }, 50.0f, Colors::Black);

		//SimpleDraw::AddScreenLine({ 0.0f, 0.0f }, { -10.0f,-100.0f }, Colors::Brown);
		//SimpleDraw::AddScreenCircle({ 10.0f, 10.0f }, 10.0f, Colors::Chocolate);
